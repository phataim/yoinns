...
'必填参数
sTime=now()
out_trade_no =olp_order_no'请与贵网站订单系统中的唯一订单号匹配
subject      = olp_product_name		'订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
body         = olp_remark		'订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
price    	 = olp_money	'订单总金额，显示在支付宝收银台里的“商品单价”里
...
'0即时到账交易：service=create_direct_pay_by_user
'1标准双接口交易： service=trade_create_by_buyer
'2担保交易： service="create_partner_trade_by_buyer"
