...
function build_form()
	'GET方式传递
	sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='"& gateway &"_input_charset="&input_charset&"' method='get' target='_blank'>"
	...
	sHtml = sHtml &"<img src=""images/onlinepay/alipay.gif"" /><br />"
sHtml = sHtml &GetAjaxSubmitButton("支付宝")
