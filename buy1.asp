    ...
    <div class="yuding_box">
        ...
        <div class="part2_cc">
            ...
            <div class="part2_ccm">
                ...
                <ul class="part2_c">
                <span class="title_c"><h3><%=housetitle%></h3><h4><%=Dream3Static.GetLodgeType(lodgeType)%>-<%=Dream3Static.GetLeaseType(leaseType)%></h4></span>
		...
		<form method="post" name="orderForm" action="buy1.asp?act=saveorder">
