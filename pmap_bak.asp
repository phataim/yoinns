...
<script language="javascript" src="<%=VirtualPath%>/common/js/jquery/gmap3.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      $(function(){
       ...
       // var center = [25.9912033508, 105.66736938];
	  var center = [<%=map_x%>,<%=map_y%>];
            ...
            marker:{
              ...
              events:{
                dragend: function(marker, event){
                  document.getElementById('map_x').value = event.latLng.lat();
		  	   	  document.getElementById('map_y').value = event.latLng.lng();
                }
              }
            },
            infowindow:{
