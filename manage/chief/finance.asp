...
<div id="content" class="coupons-box clear mainwide">
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2><%=classifierName%> (总金额：<span class="currency"><%=Dream3CLS.SiteConfig("CNYSymbol")%></span><%=totalMoney%>)</h2>
                    <ul class="filter">
						<li class="label">分类: </li>
						<li <%If classifier="reserve" Then response.Write("class='current'")%>><a href="finance.asp?c=reserve">定金</a></li>
						<li <%If classifier="cash" Then response.Write("class='current'")%>><a href="finance.asp?c=cash">现金支付</a></li>
						<li <%If classifier="manualrefund" Then response.Write("class='current'")%>><a href="finance.asp?c=manualrefund">人工退款记录</a></li>										
					</ul>
				</div>
                <div class="sect">
