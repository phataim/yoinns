        ...
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head">				
					<h2>未付订单</h2>
					<ul class="filter"><li>
					<form method="post" action="unpay.asp">
				...
				<div class="sect">
					...
					<tr <%If i mod 2 = 0 Then%>class="alt"<%End If%>>
						...
						<td><%=arrU(12,i)%></td>
						<td nowrap="" class="op"><a class="ajaxlink" onclick="return window.confirm('您确定要删除该条记录?')" href="unpay.asp?act=delete&id=<%=arrU(0,i)%>">删除</a></td>
					</tr>
					  <%
						Next
					  End If
