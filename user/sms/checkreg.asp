	...
	Sub CheckReg()
		...
		Elseif  Rs("enabled") = "N" Then
			If Rs("secret") = smssecret Then
				...
				Rs.Close
				Set Rs = Nothing
				Response.Redirect("result.asp?flag=success&mobile="&mobile)
			Else
		...
		<div id="login">
			<div class="login-box" id="content">
					...
					<div class="login-content">
						<div class="head"><h2>输入手机验证码</h2>(您正在申请短信订阅的手机为：<%=mobile%>)</div>
						<div class="sect">
							<form class="validator" method="post" action="?act=checkreg" id="login-user-form">
