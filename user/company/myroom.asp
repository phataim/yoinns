    ...
    <div class="layoutright mt9">
    	<div class="bor">
        	<div class="innr">
                ...
                <div class="discbox"><p>我的房间</p><br><a href="..\account\zhifubiangeng.html" target="_blank"><strong><span style="color:red">“有旅馆”支付方式变更!</span></strong> </a></br></div>
                    ...
                    <div class="index_r1">
                        ...
                        <div class="index_r1m">
                          ...
                          <%select case statestr %>
                           <%case "auditing" %>
                          <a href="../../preview2.asp?pid=<%=product_id%>" target=_blank><img class="img" height="100" width="150" src="<%=image%>"></a>
                               <%case "pending" %>
                              <a href="../../pstep1.asp?act=showedit&pid=<%=product_id%>"  target=_blank><img class="img" height="100" width="150" src="<%=image%>"></a>
                               <%case "unpass" %>
                               <a href="unpass.html" target=_blank><img class="img" height="100" width="150" src="<%=image%>"></a>
                                <%case "expired" %>
                              <a href="expired.html"  target=_blank><img class="img" height="100" width="150" src="<%=image%>"></a>
                                <%case else %>
                                <a href="../../detail.asp?pid=<%=product_id%>" target=_blank><img class="img" height="100" width="150" src="<%=image%>"></a>
                                <%end select %>
                            ...
                            <div class="index_r1mr">
                                ...
                                <div class="room_tt">
                                    ...
                                    <%select case statestr %>
                                    <%case "auditing" %>
                                    <a href="../../preview2.asp?pid=<%=product_id%>" target=_blank
<%=houseTitle%>——</a>
                                    <%case "pending" %>
                                     <a href="../../pstep1.asp?act=showedit&pid=<%=product_id%>" target=_blank
<%=houseTitle%>——</a>
                                    <%case "unpass" %>
                                     <a href="unpass.html" target=_blank
<%=houseTitle%>——</a>
                                    <%case "expired" %>
                                     <a href="expired.html" target=_blank
<%=houseTitle%>——</a>
                                    <%case else %>
                                    <a href="../../detail.asp?pid=<%=product_id%>" target=_blank
<%=houseTitle%>——</a>
                                    <%end select %>
									<%
								...
								Set Rs = Dream3CLS.Exec(Sql)
								%>
								<%=Rs("h_hotelname")%>--<%=houseTitle%>
								<%Rs.close%></h2><h3></h3>(<%=createTime%>发布)</div>
                                    <div class="t"><%=left(roomdesc,70)%></div>
                                </div>
                                <div class="room_bb">
                                    <div class="t1"> 
                                    ...
                                    <div class="yym-room">
                                        ...
                                        <li class="li5">
											<a href="<%=VirtualPath%>/cprice2.asp?pid=<%=product_id%>">改价格</a>
										<%Else%>
										    <%If statestr="normal" Then %>
										    <li class="li5">
											<a href="<%=VirtualPath%>/cprice.asp?pid=<%=product_id%>">改价格</a>
											<%Else %>
                                        ...
                                        <%If statestr = "auditing" Then%>
                                        <li class="li1">
											<a href="<%=VirtualPath%>/cpicture.asp?pid=<%=product_id%>">改图片</a>
										<%Else%>
										    <%If statestr="normal" Then %>
										    <li class="li1">
											<a href="<%=VirtualPath%>/cpicture.asp?pid=<%=product_id%>">改图片</a>
											<%Else %>
											<li class="li3unable">改图片
											<%End If %>
										<%End If%>
                                        </ul>
                                    </div>
