...
Dim classifier,classifierStyle
	...
	Sub Main()	
		...
		Sql = "Select id,state,housetitle,lodgetype,leasetype,roomtitle,image,create_time,address,dayrentprice,weekrentprice,monthrentprice,online from T_Product Where 1=1 "&searchStr
        	...
        	<div class="innr">
                ...
                <div class="search_con clearfix">
                    ...
                    <div class="menu_myroom">
                    	<ul class="cont">
                        	<li <%If classifierStyle = "all" Then%>class="current"<%End If%>><a href="?c=all">全部房间</a></li>
                    ...
                    <div class="index_r1">
                        ...
                        <div class="index_r1m">
                            ...
                            <div class="index_r1mr">
                                <h3 class="tit_st"><%=housetitle%></h3>
                                <div class="room_tt">
                                    <div class="t"><h1></h1><h2><%=lodgeType%>*<%=leaseType%></h2><h3></h3>(<%=createTime%>发布)</div>
                                ...
                                <div class="room_bb">
                                    ...
                                    <div class="yym-room">
										...
										%>
                                        <li class="li1">
											<a href="<%=VirtualPath%>/publish.asp?act=showedit&pid=<%=product_id%>" <%=s_alert_str%>>修改</a>
										</li>
