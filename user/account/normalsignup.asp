...
<%
Dim Action
Dim username,email,password,confirm,city_id,mobile,subscribe,userid,manager,validcode,affirm,reg_code
	...
	Sub SaveRecord()
		...
		Response.Write "<script language=JavaScript>" & chr(13) & "alert('注册成功');" & "location.href='../../index.asp';" & "</script>" 
    ...
    <div class="reg_cente">
    	<div class="reg_left">
        	<dl>
            	<dt>普通用户注册</dt>
				<dd>用户名/昵称：
				<input type="text" value="手机号码/邮箱/用户名" class="reg_txt" id="username" name="username"onclick="value='';focus()"
>                <span class="validatorMsg"><br />填写4-16个字符，一个汉字为两个字符。</span>
        ...
        <dl>
        <dl>
            <dt class="font18">我是商家，免费发布住宿信息</dt>
                <dd><a class="reg_log" href="companysignup.asp">商家注册</a></dd></dl></dl>
    </div>
