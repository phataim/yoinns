...
cmEmail.SendObject	= Cint(Dream3CLS.SiteConfig("SelectMailMode"))		'设置选取组件 1=Jmail,2=Cdonts,3=Aspemail
cmEmail.ServerLoginName	= Dream3CLS.SiteConfig("SmtpServerUserName")		'您的邮件服务器登录名
cmEmail.ServerLoginPass	= Dream3CLS.SiteConfig("SmtpServerPassword")		'登录密码
cmEmail.SendSMTP	= Dream3CLS.SiteConfig("SmtpServer")		'SMTP地址
cmEmail.SendFromEmail	= Dream3CLS.SiteConfig("SmtpServerMail")		'发送来源地址
cmEmail.SendFromName	= Dream3CLS.SiteConfig("SiteName")			'发送人信息
