...
var PImgPlayer = {   
        ...
        init : function( objID, w, h, time ){   
                ...
                //   
                var ulStyle = "margin:0;width:"+w+"px;position:absolute;right:5px;FILTER:Alpha(Opacity=50,FinishOpacity=50, Style=1);overflow: hidden;bottom:-1px;height:16px; border-right:1px solid #fff;";   
                //   
				...
				if(this._items[this._index].link != ""){
					html = "<a href=\""+this._items[this._index].link+"\" title=\""+this._items[this._index].title+"\" target=\"_blank\" style=\""+linkStyle+"\"></a><ul style=\""+ulStyle+"\">"+ulHTML+"</ul>"; 
				}else{
					html = "<a href=# title=\""+this._items[this._index].title+"\" style=\""+linkStyle+"\"></a><ul style=\""+ulStyle+"\">"+ulHTML+"</ul>"; 
				}
