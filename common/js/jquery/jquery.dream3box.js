...
;(function($){
	...
	$.dream3box = function($elements,s){
		...
		$.dream3box.setSize();
		//定位
		$.dream3box.setPosition();
		$.o.clo.click(function(){
			$.dream3box.hide();
		});

		if(s.autoClose > 0){
			timeout = setTimeout($.dream3box.hide, s.autoClose);
		}
	};
	$.dream3box.getSize = function(o){
		//获取任意元素的高宽
		var w_h = {};
	...
	$.dream3box.setSize = function(){
		...
		if(!bd_w || bd_w <= 0 ){
			var x_size = $.dream3box.getSize($.o.ele), w = $(window).width();
			//宽度自动
			bd_w = x_size.w;
			if(bd_w < 50){
				bd_w = 120;
	...
	$.dream3box.setPosition = function(){
