...
<div class="area">
    ...
    <div class="Details-tit">
    	<span class="t6"><b>房间详情</b></span>
        <span class="t8"><b>上传照片</b></span>
        <span class="t10"><b>设施服务</b></span>
        <span class="t12"><b>设施服务</b></span>
    ...
    <div class="tj-btn">
        <dl class="right">
            <dd class="font14_white"><a href="pstep1.asp?pid=<%=pid%>"><img src="images/xiugai.jpg" alt="修改" /></a></dd>
			<dd><a href="index.asp"><img src="images/shouye.jpg" alt="首页" /></a></dd>
        </dl>
        <div class="clear"></div>
    </div>
