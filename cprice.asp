    ...
    <div class="layer2">
		...
		<form class="validator"  action="?act=save" method="post" id="productForm" name="productForm">
            ...
            <div class="detail-right">
                ...
                <dl>
                    ...
                    <input type="text"  name="dayrentprice" id="dayrentprice" class="radius input" value="<%=dayrentprice%>" onchange="change_normalprice_commit(<%=pid %>,1)">元/每晚<span style="color:red">*</span>
                    <span id="tip_daypriceunit"></span>
                    </dd>
                    <dd>
                    <label>周末(周五周六)价：</label>
                    <input type="text" name="weekrentprice"  id="weekrentprice" class="radius input" value="<%=weekrentprice%>" onchange="change_normalprice_commit(<%=pid %>,2)">元/每晚<span style="color:red">*</span>
        ...
        <div class="next">
			<dl>
				...
				<dd><input type="button" id="searchBt" value="完成" class="input_next" onclick="productForm.submit()"></dd>
			</dl>
		</div>
        <div class="clear"></div>
    </div>
